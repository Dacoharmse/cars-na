        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="inline-block mb-4">
              <Image src="/cars-na-logo.png" alt="Cars.na" width={120} height={40} className="h-8 w-auto" />
            </Link>
            <p className="text-sm text-gray-500 leading-relaxed">
              Namibia&apos;s trusted car marketplace.
            </p>
          </div>

          {/* Buy */}
          <div>
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Buy</h3>
            <ul className="space-y-2">
              {[
                { href: '/vehicles', label: 'Browse Cars' },
                { href: '/vehicles?isNew=true', label: 'New Cars' },
                { href: '/vehicles?isNew=false', label: 'Used Cars' },
          ...
          {/* Sell */}
          <div>
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Sell</h3>
            <ul className="space-y-2">
              {[
